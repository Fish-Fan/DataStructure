    ...
    private void initEdge(List<GraphEdge> edgeList) {
        for(int i = 0;i < edgeList.size();i++) {
            ...
            if(contains(graphEdge.vex) && contains(graphEdge.otherVex)) {
                ...
                System.out.println("顶点 " + vertex.vName + " 的边链表的首节点为: " + vertex.firstEdge.iVex + "--" + vertex.firstEdge.jVex);
                System.out.println("顶点 " + oVertex.vName + " 的边链表的首节点为: " + oVertex.firstEdge.iVex + "--" + oVertex.firstEdge.jVex);
            }
